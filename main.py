...
while True:
   ...
   if (ball.xcor() > 340) and (ball.xcor() < 350) and (rightpaddle.ycor() + 40 > ball.ycor() > rightpaddle.ycor() - 40):

       ball.setx(ball.xcor() - ballxdirection)
       os.system("afplay paddle.wav&")

   if (ball.xcor() < -340) and (ball.xcor() > -350) and (leftpaddle.ycor() + 40 > ball.ycor() > leftpaddle.ycor() - 40):
